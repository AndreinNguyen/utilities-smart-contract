...
contract cloneFactory {
    ...
    // function createCloneCollection(bytes calldata _requestId, address collectionContractAddress)
    //     public
    //     returns (address)
    // {
    //     _collectionIds.increment();
    //     address cloneCollection = createClone(collectionContractAddress);
    //     collectionIdstoAddress[_collectionIds.current()] = cloneCollection;
    //     emit CreateCloneCollection(_requestId, _collectionIds.current(), cloneCollection);
